          ...
          <div className="w-full max-w-full px-3 mb-6 mx-auto">
            <div className="relative flex-[1_auto] flex flex-col break-words min-w-0 bg-clip-border rounded-[.95rem] bg-white m-5">
              <div className="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                ...
                {/* end card header */}
                {/* card body  */}
                <div className="flex-auto block py-8 pt-6 px-9" style={{backgroundColor:"#faf7f5"}}>
                    ...
                    <table className="w-full my-0 align-middle text-dark border-neutral-200">
                      <thead className="align-bottom">
                        <tr className="font-semibold text-[0.95rem] text-secondary-dark">
                          ...
                          <th className="pb-3 text-end min-w-[100px]">SERVICE TYPE</th>
                      ...
                      <tbody>
                        {requests.length > 0 ? (
                          requests.map((request, index) => (
                            <tr key={index} onClick={() => handleRowClick(request.serviceRequestID)}>
                              <td >
                              ...
                              <td className="p-3 pr-0 text-end">
                                {/* Assuming service type is static */}
                                <span className="text-light-inverse text-md/normal">criminal law</span>
                              </td>
