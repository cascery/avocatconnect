  ...
  <div className="antialiased bg-gray-100 dark-mode:bg-gray-900">
    <div className="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
      <div x-data="{ open: true }" className="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        ...
        style={{backgroundColor:"#fae7f4",width:"500px",marginBottom:"50px",left:"0",right:"0"   ,
       ...
       boxShadow: "4px 4px #222222",
            ...
            <form className="space-y-12" onSubmit={handleFormSubmit}>
                ...
                <div className="space-y-2">
                    <div>
                        <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md bg-violet-600 text-gray-50"
                        
                        style={{backgroundColor:"#8c0327" ,color:"white"}}
                        >Sign in</button>
                    </div>
